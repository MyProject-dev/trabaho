...
function clean_magazine_header_highlight_content_display() {
	...
	if ( $enablecontent == 'entire-site' || ( ( is_front_page() || ( is_home() && $page_for_posts != $page_id ) ) && $enablecontent == 'homepage' ) ) {
		if ( ( !$clean_magazine_header_highlight_content = get_transient( 'clean_magazine_header_highlight_content' ) ) ) {
			...
			if ( $contentselect == 'demo-header-highlight-content' ) {
				$classes .= ' demo-header-highlight-content' ;
			}
			elseif ( $contentselect == 'header-highlight-page-content' ) {
				...
				<section id="header-highlights-content" class="' . $classes . '">
					<div class="wrapper">';
						...
						<div class="header-highlight-content-wrap">';
							// Select content
							if ( $contentselect == 'demo-header-highlight-content' && function_exists( 'clean_magazine_demo_header_highlight_content' ) ) {
								$clean_magazine_header_highlight_content .= clean_magazine_demo_header_highlight_content( $options );
							}
							elseif ( $contentselect == 'header-highlight-page-content' && function_exists( 'clean_magazine_header_highlight_page_content' ) ) {
	...
	$clean_magazine_demo_content = '
		<article id="large-featured-image" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="Gibson Les Paul" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured-1920x800.jpg" />
				</a>
			</figure>
		...
		<article id="header-highlight-post-1" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="White Velvet Concert" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured1-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="header-highlight-post-2" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a rel="bookmark" href="#">
					<img alt="Female Rockstar" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured2-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
		...
		<article id="header-highlight-post-4" class="post hentry post-demo">
			<figure class="header-highlight-content-image">
				<a href="#">
					<img alt="Best Rock Band" class="wp-post-image" src="'.get_template_directory_uri() . '/images/gallery/featured4-480x320.jpg" />
				</a>
			</figure>
			<div class="entry-container">
				<header class="entry-header">
