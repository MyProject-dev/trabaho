...
function clean_magazine_news_ticker_display() {
	...
	if ( $enablecontent == 'entire-site' || ( ( is_front_page() || ( is_home() && $page_for_posts != $page_id ) ) && $enablecontent == 'homepage' ) ) {
		if ( ( !$clean_magazine_news_ticker = get_transient( 'clean_magazine_news_ticker' ) ) ) {
			...
			if ( $contentselect == 'demo-news-ticker' ) {
					...
					<div class="wrapper">';
						...
						<div class="new-ticket-content">
							<div class=" news-ticker-slider cycle-slideshow"
								...
								// Select content
								if ( $contentselect == 'demo-news-ticker' && function_exists( 'clean_magazine_demo_ticker' ) ) {
									$clean_magazine_news_ticker .= clean_magazine_demo_ticker( $options );
								}
								elseif ( $contentselect == 'page-news-ticker' && function_exists( 'clean_magazine_page_ticker' ) ) {
...
function clean_magazine_page_ticker( $options ) {
	...
	$show_content	= isset( $options['news_ticker_show'] ) ? $options['news_ticker_show'] : 'excerpt';
