...
if ( ! function_exists( 'clean_magazine_setup' ) ) :
	...
	function clean_magazine_setup() {
		...
		//Change default thumbnail size to 90x68
		update_option( 'thumbnail_size_w', 90 );
		update_option( 'thumbnail_size_h', 68 );
 ...
 * Default Options.
 */
require get_template_directory() . '/inc/clean-magazine-default-options.php';

/**
 * Custom Header.
 */
require get_template_directory() . '/inc/clean-magazine-custom-header.php';


/**
 * Structure for Clean Magazine
 */
require get_template_directory() . '/inc/clean-magazine-structure.php';


/**
 * Customizer additions.
 */
require get_template_directory() . '/inc/customizer-includes/clean-magazine-customizer.php';


/**
 * Custom Menus
 */
require get_template_directory() . '/inc/clean-magazine-menus.php';


/**
 * Load Header Highlight Content file.
 */
require get_template_directory() . '/inc/clean-magazine-header-highlight-content.php';


/**
 * Load Slider file.
 */
require get_template_directory() . '/inc/clean-magazine-featured-slider.php';


/**
 * Load Featured Content.
 */
require get_template_directory() . '/inc/clean-magazine-featured-content.php';


/**
 * News Ticker
 */
require get_template_directory() . '/inc/clean-magazine-news-ticker.php';


/**
 * Load Breadcrumb file.
 */
require get_template_directory() . '/inc/clean-magazine-breadcrumb.php';
 ...
 * Load Social Icons
 */
require get_template_directory() . '/inc/clean-magazine-social-icons.php';


/**
 * Load Metaboxes
 */
require get_template_directory() . '/inc/clean-magazine-metabox.php';
		...
		if ( has_post_thumbnail() && 'full-content' != $featured_image ) { ?>
			<figure class="featured-image">
	            ...
	            <?php
						...
						elseif ( $featured_image == 'excerpt-image-left' ) {
